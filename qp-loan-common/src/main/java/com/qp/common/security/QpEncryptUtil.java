 ...
 */
public class QpEncryptUtil {

	private static final Object sb = null;
	...
	public static String getSign(Map<String, String> paramsMap, String secretKey) {
		if (QpStringUtil.isEmpty(secretKey)) {
	...
	public static void main(String[] args) {
		String plainText="asdq";
		String key = "key";
		System.out.println(encoderByDES(plainText,key));
		System.out.println(decoderByDES(encoderByDES(plainText,key),key));
	}
