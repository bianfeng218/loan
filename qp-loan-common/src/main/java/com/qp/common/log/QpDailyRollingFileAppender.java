 ...
 * 
 */
public class QpDailyRollingFileAppender extends FileAppender {
	 ...
	 */
	public QpDailyRollingFileAppender() {
	}

	/**
	 * 改造过的构造器
	 */
	public QpDailyRollingFileAppender(Layout layout, String filename,
